...
public class DrawPanel extends JComponent {
    ...
    double[] imag = new double[1024]; //типо массив с комплексными частями чисел, которых на деле нет, но требуются реализацией FFT
    private final double [] y1Spectrum = FFTbase.fft(Harm.get_harmonic_signal(1*SPECTRUM_CALIBRATION), imag, true);  //спектр гармонического сигнала с частотой 1
    private final double [] y2Spectrum = FFTbase.fft(Harm.get_harmonic_signal(2*SPECTRUM_CALIBRATION), imag, true);  //спектр гармонического сигнала с частотой 2
    private final double [] y3Spectrum = FFTbase.fft(Harm.get_harmonic_signal(4*SPECTRUM_CALIBRATION), imag, true);  //спектр гармонического сигнала с частотой 4
    private final double [] y4Spectrum = FFTbase.fft(Harm.get_harmonic_signal(8*SPECTRUM_CALIBRATION), imag, true);  //спектр гармонического сигнала с частотой 8
    ...
    private final double [] y5Spectrum = FFTbase.fft(Mean.get_meander_signal(1*MEANDER_CALIBRATION), imag, true);  //спектр меандра с частотой 1
    private final double [] y6Spectrum = FFTbase.fft(Mean.get_meander_signal(2*MEANDER_CALIBRATION), imag, true);  //спектр меандра с частотой 2
    private final double [] y7Spectrum = FFTbase.fft(Mean.get_meander_signal(4*MEANDER_CALIBRATION), imag, true);  //спектр меандра с частотой 4
    private final double [] y8Spectrum = FFTbase.fft(Mean.get_meander_signal(8*MEANDER_CALIBRATION), imag, true);  //спектр меандра с частотой 8
